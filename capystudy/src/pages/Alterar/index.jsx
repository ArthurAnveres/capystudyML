...
export const ChangePassword = () => {
    ...
    useEffect(() => {
        ...
        axios.get(`http://localhost:3333/esqueci?token=${token}`)
        .then((res) => {
    ...
    const onSubmit = (data) => {
        ...
        axios.patch("http://localhost:3333/esqueci", {
            token: token,
        ...
        .catch((err) => {
            setMessage("Informe o proprietário do site sobre esse erro")
        })
    }
                ...
                && (
                    <div className='flex flex-col gap-4 bg-white px-4 py-8 rounded-md shadow-md'>
                        <form className='flex flex-col gap-3' onSubmit={handleSubmit(onSubmit)}>
                            ...
                            />
                            <span className={['text-red-500 text-sm text-center font-medium font-mono select-none',]}>{message}&nbsp;</span>
                            <div>
